...
#
#
# to do: 1. button that resets 2. reset after game 3.fix mustiple win bug 4. random generator
...
#center_spin1
	...
	if (board[7] == 'x') and (board[5] == 'x') and (board[2] != 'x') and (board[2] != 'o')  and (change_made == 0):
		board[2] = 'o'
		change_made = 1
		
	if (board[8] == 'x') and (board[5] == 'x') and (board[7] != 'x') and (board[7] != 'o') and (change_made == 0):
		board[7] = 'o'
		change_made = 1
...
if (a == "y") and (b == 'y'):
	while (True) :
		...
		time.sleep(3)
		print('Tou are the Computer O player')
		#time.sleep(3)
		c_player()
